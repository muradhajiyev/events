...
public class ExhibitionActivity extends AppCompatActivity {
    ...
    private void select_from_exhibition(String id) {
        eventsapi.selectExhibition(new select_domain(id), new Callback<Exhibition>() {
            @Override
            public void success(Exhibition exhibition, Response response) {
                Picasso.with(getApplication())
                        .load(Webservice_urls.image_url + exhibition.getLOGO_NAME())
                        .into(logo);
            ...
            public void failure(RetrofitError error) {
                Toast.makeText(ExhibitionActivity.this, "Something went wrong, Please try again.", Toast.LENGTH_LONG).show();
            }
        });
